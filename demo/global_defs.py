...
class MetaSeg:
  ...
  METASEG_MODEL_NAMES    = [ "slim_squeeze_unet" ]
  METASEG_CLASS_DTYPES   = [ "one_hot_classes","probs" ]

  METASEG_MODEL_NAME     = METASEG_MODEL_NAMES[0]

  METASEG_READ_DATA_PATH = "./"
  METASEG_MY_IO_PATH     = "./seg_uncertainty/metaseg_io/"
  ...
  METASEG = { "MODEL_NAMES"          : METASEG_MODEL_NAMES, \
              ...
              "IMG_DIR"              : METASEG_READ_DATA_PATH + "/images", \
              ...
              "CLASS_DTYPE"          : METASEG_CLASS_DTYPES[0]
            }
