...
from sklearn.metrics import accuracy_score, f1_score, precision_score, matthews_corrcoef, classification_report
...
class KnnPrediction:
    ...
    def fit_model(self, X_train, y_train, X_test, y_test, save_model=False, draw_graph=False):
        f1_scores = []
