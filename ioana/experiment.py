...
from sklearn.metrics import classification_report, precision_score, f1_score, matthews_corrcoef, accuracy_score
...
class KnnPrediction:
    ...
    def fit_model(self, X_train, y_train, X_test, y_test, save_model=False, draw_graph=True):
        f1_scores = []
...
if __name__ == "__main__":
    knn = KnnPrediction(0.75, "/home/agriadapt/agriadapt/train_features_with_labels_width_0.75.pickle",
